                        ...
                        <div class="container-fluid">
                            <form method="post" id="NIVEL">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="col-form-label" for="archivo_aula"><i class="far fa-user"></i> Imagen: </label>
                                            <input id="archivo_aula" type="file" class="form-control is-warning" name="archivo_aula" placeholder=".png, . jpg o .gif" accept=".gif, .jpg, .png">                                            
                                        </div>
