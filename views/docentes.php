        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="container-fluid">
                    ...
                    <section class="content">
                        <div class="container-fluid">
                            <form method="post" id="DOCENTE" autocomplete="off">
                                <div class="row">
                                    <div class="col-md-6">
                    ...
                    <div class="col-md-3">
                        <div class="input-group input-group-lg">
                            ...
                            <div class="col-md-6">
                                ...
                                <a href="../core/reports/docentes.php" target="_blank" class="btn waves-effect amber tooltipped" data-tooltip="Reporte de docentes en aulas asignadas"><i class="material-icons">Reporte de docentes en aulas asignadas</i></a>
                            </div>
                        </div>
                    </div>
                </form>
