...
const API_SECCCION = '../core/api/secciones.php?action=readAll';

// Método que se ejecuta cuando el documento está listo.
$( document ).ready(function() {
    // Se llama a la función que obtiene los registros para llenar la tabla. Se encuentra en el archivo components.js   
    fillSelect( API_ESPECIALIDAD, 'especialidad', null );    
    fillSelect( API_SECCCION, 'seccion', null );       
...
function openUpdateModal( id )
{
    ...
    .done(function( response ){
        ...
        if ( response.status ) {
            ...
            fillSelect( API_SECCCION, 'seccion', response.dataset.seccion_estudiante )
